package org.wpattern.learning.object.search.beans;
...
public class NodeBean extends BaseBean implements Cloneable {
	...
	public NodeBean() {
		this.setLearningObjects(new ArrayList<LearningObjectBean>() {
			...
			public void add(int arg0, LearningObjectBean arg1) {
				super.add(arg0, arg1);
				NodeBean.this.hashCode = NodeBean.this.calculateHash();
			}
	...
	public NodeBean clone() {
		try {
			NodeBean newObject = (NodeBean) super.clone();
